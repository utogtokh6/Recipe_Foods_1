...
export const clearRecipe = () => {
    // Odoo baigaa Joriig delgetse deerees tseverlene
    elements.recipeDev.innerHTML = "";
};

export const renderRecipe = (recipe, isLiked) => {
    // Ene Joriig delgetsen gargaj uzuulne
    ...
    elements.recipeDev.insertAdjacentHTML('afterbegin',html);
}
